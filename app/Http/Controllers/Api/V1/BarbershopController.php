                ...
                content: new OA\JsonContent(properties: [
                    ...
                    new OA\Property(property: 'data', properties: [
                        new OA\Property(property: 'data', type: 'array', items: new OA\Items(properties: [
                            ...
                            new OA\Property(property: 'min_price', type: 'integer', nullable: true, example: 1500),
                            new OA\Property(property: 'min_price_display', type: 'string', nullable: true, example: 'от 1500 ₸'),
                    ...
                    new OA\Property(property: 'data', properties: [
                        ...
                        new OA\Property(property: 'services', type: 'array', items: new OA\Items(properties: [
                            ...
                            new OA\Property(property: 'items', type: 'array', items: new OA\Items(properties: [
                                ...
                                new OA\Property(property: 'price_display', type: 'string', example: '1500 ₸'),
